...
export default function Home() {
  ...
  useEffect(() => {
    ...
    initFFmpeg();
  }, [processor.ffmpeg.load, stateMachine.failProcessing]);
  ...
  }, [processor.result, stateMachine.state, stateMachine.currentAction, stateMachine.completeProcessing]);
  ...
  }, [processor.error, stateMachine.state, stateMachine.failProcessing]);
